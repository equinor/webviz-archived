...
class Theme(_Theme):
    ...
    There are is one entry template: `main.html`,
    that is rendered for each page.
    ...
    :param css_files: List of additional css_files to be included on each page.
    :param js_files: List of additional js_files to be included on each page.
